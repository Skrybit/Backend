...
exports.input = exports.select = exports.splitArgs = void 0;
...
const customScripts = [index_js_1.OutOrdinalReveal];
...
function getKeys(net, opts) {
    const KEYS = { priv: 'Temporary', recovery: 'Recovery' };
    const res = {};
...
function getPayment(privKey, recovery, inscription, net) {
    ...
    return (0, btc_signer_1.p2tr)(recoveryPub, (0, index_js_1.p2tr_ord_reveal)(pubKey, [inscription]), net, false, customScripts);
}
